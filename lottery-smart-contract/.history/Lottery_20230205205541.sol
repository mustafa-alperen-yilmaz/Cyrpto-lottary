...
contract Lottery {
    ...
    uint256 public constant maxTickets = 1000000; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.0005 ether; // commition per ticket
    uint256 public constant duration = 60 minutes; // The duration set for the lottery
