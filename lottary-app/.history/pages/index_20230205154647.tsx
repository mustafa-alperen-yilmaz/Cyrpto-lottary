...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-[#00363a] min-h-screen flex flex-col">
      <Head>
      ...
      <Marquee className="bg-[#127465]" gradient={false} speed={100}>
        <div className="flex space-x-2 mx-10">
          <h4 className='text-white font-light'>Last Winner ... {lastWinner?.toString()} </h4>
          <h4 className='text-white font-semibold'>Previus Winnings ... {lastWinnerAmount && ethers.utils.formatEther(lastWinnerAmount?.toString())} {currency} </h4>
        </div>
      </Marquee>
        ...
        <div className="stats-container space-y-2">
          <div className="stats-container">
            ...
            <div className="flex text-white items-center space-x-2 bg-[#091B18] border-[#21011e] border p-4" >
              <p style={{ marginBottom: '1rem' }}>TICKETS</p>
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-between p-5">
        <img className="h-10 w-10 filter hue-rotate-90 opacity-20 rounded-full" src={warningIcon} alt="warning"/>
